...
const Navbar = (props) => {
  ...
  const primaryScreens = ["AddEvent", "ExpenseScreen", "AddPaymentPage", "Profile"]
  const secondaryScreens = ["Exp1", "Exp2", "Exp3", "Exp4"]
  ...
  const handleBackPress = () => {
    ...
    else if (secondaryScreens.includes(route.name)) {
